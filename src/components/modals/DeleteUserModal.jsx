  ...
  return (
    <div className="fixed right-0 bottom-0 top-0 left-0 flex items-center justify-center z-[1201]">
      <div
        ...
        onClick={() => DeleteUserModalShow(false)}
      ></div>
      <section className="mb-[20px] rounded bg-[#282D36] w-[400px] z-[100000]">
        <header className="p-[18px] text-white flex justify-between items-center">
          <h2 className="mt-[5px] text-[20px] font-normal">Remote WL user</h2>
          <button
        ...
        <div className="p-[15px] bg-[#2E353E] text-white text-center">
          <p className="pb-[10px] text-sm">
            Are you sure you want to revoke access for <font className="font-bold">Profile</font>
          </p>
          <p className="box-border font-bold">{selectedUserName}?</p>
        ...
        <footer className="px-4 py-3 text-white flex justify-end items-center">
          <LoadingButton
            ...
            onClick={handleDeleteUserModalButtonClicked}
            loading={isLoading}
...
DeleteUserModal.propTypes = {
  DeleteUserModalShow: PropTypes.func.isRequired,
  selectedUserName: PropTypes.string.isRequired,
  handleDeleteUserModalButtonClicked: PropTypes.func.isRequired,
